...
public final class SKDResponseDictionary {
    ...
    public subscript(key: KeyPath<sourcekitd_keys, sourcekitd_uid_t>) -> String? {
        self[sourcekitd.keys[keyPath: key]]
    }
    ...
    @inlinable
    public subscript(key: KeyPath<sourcekitd_keys, sourcekitd_uid_t>) -> Bool? {
        self[sourcekitd.keys[keyPath: key]]
    }
    ...
    @inlinable
    public subscript(key: KeyPath<sourcekitd_keys, sourcekitd_uid_t>) -> SKDResponseArray? {
        self[sourcekitd.keys[keyPath: key]]
    }
}
